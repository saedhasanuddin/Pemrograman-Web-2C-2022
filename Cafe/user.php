  ...
  <tbody>
    ...
    <tr>
      ...
      <td class="d-flex">
        ...
        <button class="btn btn-warning btn-sm me-1" data-bs-toggle="modal" data-bs-target="#ModalView"><i class="bi bi-pencil-square"></i></button>
        <button class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#ModalView"><i class="bi bi-trash"></i></button>
      </td>
    </tr>
    <?php }?>
  </tbody>
